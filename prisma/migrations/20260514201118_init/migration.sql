-- CreateEnum
CREATE TYPE "Role" AS ENUM ('superadmin', 'admin', 'dispatcher', 'tech', 'readonly');

-- CreateEnum
CREATE TYPE "JobStatus" AS ENUM ('open', 'scheduled', 'in_progress', 'done');
...
-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('card', 'cash', 'check', 'digital');
...
CREATE TABLE "Invoice" (
    ...
    "parts" DOUBLE PRECISION NOT NULL DEFAULT 0,
...
CREATE TABLE "Equipment" (
    ...
    "lastPMDaysAgo" INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE "Contract" (
    ...
    "techInitials" TEXT NOT NULL DEFAULT '',
    "frequencyDays" INTEGER NOT NULL DEFAULT 90,
    "pricePerVisit" DOUBLE PRECISION NOT NULL,
...
-- CreateTable
CREATE TABLE "_JobEquipment" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL,

    CONSTRAINT "_JobEquipment_AB_pkey" PRIMARY KEY ("A","B")
);
...
-- CreateIndex
CREATE INDEX "_JobEquipment_B_index" ON "_JobEquipment"("B");
...
-- AddForeignKey
ALTER TABLE "_JobEquipment" ADD CONSTRAINT "_JobEquipment_A_fkey" FOREIGN KEY ("A") REFERENCES "Equipment"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_JobEquipment" ADD CONSTRAINT "_JobEquipment_B_fkey" FOREIGN KEY ("B") REFERENCES "Job"("id") ON DELETE CASCADE ON UPDATE CASCADE;
