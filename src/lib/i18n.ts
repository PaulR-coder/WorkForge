...
const T = {
  en: {
    ...
    deleteJob: 'Archive this job? It will be moved to History and can be restored.',
  ...
  es: {
    ...
    deleteJob: '¿Archivar esta orden? Se moverá a Historial y podrá restaurarse.',
